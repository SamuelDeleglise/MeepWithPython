...
from meep import *
import time
from my_meep.structures.briques import make_fields,my_space,gridSizeX,gridSizeY,border,srcFreqCenter,srcPulseWidth
...
for fields,ext in zip((my_fields_cal,my_fields),("cal","run")):
    ...
    run_and_gif(fields,my_space,steps = 15000,frames = 200,filename = "blochVertical_" + ext + ".gif")
...
plot(freq,(out[1]+(inp[0] - inp[1]))/inp[0],label = "total")
