...
from meep import *
import time
from my_meep.structures.blochMirror import make_fields,my_space,gridSizeX,gridSizeY,border,srcFreqCenter,srcPulseWidth
...
for fields,ext in zip((my_fields_cal,my_fields),("cal","run")):
    ...
    run_and_gif(fields,my_space,steps = 4000,frames = 200,filename = "blochMirror_" + ext + ".gif")
